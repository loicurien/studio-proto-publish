...
exports.THE_OFFICE_PUNCHLINES = exports.THE_OFFICE_TITLES = void 0;
exports.getRandomOfficeSuggestion = getRandomOfficeSuggestion;
exports.THE_OFFICE_TITLES = [
...
function getRandomOfficeSuggestion() {
    const title = pickRandom(exports.THE_OFFICE_TITLES);
    const oneLiner = pickRandom(exports.THE_OFFICE_PUNCHLINES);
    const extra = pickRandomN(exports.THE_OFFICE_PUNCHLINES.filter((p) => p !== oneLiner), 2);
...
//# sourceMappingURL=the-office-suggestions.js.map